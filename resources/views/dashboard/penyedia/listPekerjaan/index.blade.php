                ...
                <div class="space-y-6">
                    @foreach($jobs as $job)
                        <div class="p-6 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg shadow-md transition transform hover:scale-105 hover:shadow-lg">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('list-pekerjaan', $job->id) }}" class="inline-block bg-gradient-to-r from-purple-600 to-blue-500 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-purple-500 transition">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
